...
const proposalMemoryListChannel = 'data-lab:proposal-memory-list'
const proposalMemoryRememberChannel = 'data-lab:proposal-memory-remember'
const proposalMemoryStatusChannel = 'data-lab:proposal-memory-status'
