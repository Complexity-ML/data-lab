...
export function buildPipelineAgentRequest(input: AgentContextInput & { datahubEvidence: string[]; incidentContext?: IncidentSummary[]; objective: string; responseLanguage?: 'English' | 'French' }) {
  return {
